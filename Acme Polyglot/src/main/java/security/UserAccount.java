...
public class UserAccount extends DomainEntity implements UserDetails {
	...
	public boolean containsAuthority(String authString){
		boolean result = false;
		Collection<Authority> collectAuth = getAuthorities();
		for(Authority a: collectAuth){
			if(a.getAuthority().equals(authString)){
				result = true;
				break;
			}
		}
