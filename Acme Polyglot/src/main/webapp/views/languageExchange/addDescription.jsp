...
<form:form action="languageExchange/polyglot/addDescription.do?languageExchangeId=${languageExchangeId}" modelAttribute="description">
	<fieldset>
		<legend align="left">
	...
	<acme:select code="languageExchange.descriptionLanguage" path="Language" items="${languages}" itemLabel="code" id="languages" />
