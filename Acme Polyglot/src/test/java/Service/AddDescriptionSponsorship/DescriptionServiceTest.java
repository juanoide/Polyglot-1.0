package Service.AddDescriptionSponsorship;
...
// POSITIVE TEST CASE: An agent can add description
// a sponsorships owner.

	@Transactional
	@Test
	public void testAddDescriptionSponsorship() {
	...
	// Negative TEST CASE: An agent cannot add description
	// a sponsorships  that is not him.
	@Test(expected = NullPointerException.class)
	public void testAddDescriptionSponsorshipNoMy() {
		authentificate("agent1");
		Collection<String> links= new ArrayList<String>();
		links.add("https://projetsii3q7vprzje3n44wfxr/issues");
		links.add("https://projetsiasasafa/issues");
	...
	public void testAddDescriptionSponsorshipNotAutehntificated() {
		desauthentificate();
	...
	// Negative TEST CASE: An agent cannot add description null
	// a sponsorships
	@Transactional
	@Test(expected = IllegalArgumentException.class)
	public void testAddDescriptionSponsorshipWithDescriptionNull() {
