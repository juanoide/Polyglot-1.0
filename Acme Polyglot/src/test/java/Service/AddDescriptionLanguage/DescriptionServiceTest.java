package Service.AddDescriptionLanguage;
...
public class DescriptionServiceTest {
	...
	// POSITIVE TEST CASE: An administrator can add description
	// a language
	
	@Transactional
	@Test
	public void testAddDescriptionLanguage() {
	...
	public void testAddDescriptionLanguageNotAutehntificated() {
		desauthentificate();
	...
	// Negative TEST CASE: An administrator cannot add description null
	// a language.
	
	@Transactional
	@Test(expected = IllegalArgumentException.class)
	public void testAddDescriptionLanguageWithDescriptionNull() {
