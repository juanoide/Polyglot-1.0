package Service.AddDescriptionLanguageExchange;
...
public class DescriptionServiceTest {
	...
	// A user who is authenticated as an polyglot
		...
		// POSITIVE TEST CASE: An polyglot can add description
		// a languageExchange
	
	@Transactional
	@Test
	public void testAddDescriptionLanguageExchange() {
	...
	// Negative TEST CASE: An polyglot cannot add description
	// a languageExchange  that is not him.
	@Test(expected = NullPointerException.class)
	public void testAddDescriptionLanguageExchangeNoMy() {
		authentificate("polyglot1");
		Collection<String> links= new ArrayList<String>();
		links.add("https://projetsii3q7vprzje3n44wfxr/issues");
		links.add("https://projetsiasasafa/issues");
	...
	// Negative TEST CASE: An anonymous cannot add description
	// a languageExchange.

	@Transactional
	@Test(expected = IllegalArgumentException.class)
	public void testAddDescriptionLanguageExchangeNotAutehntificated() {
		desauthentificate();
	...
	// Negative TEST CASE: An polyglot cannot add description null
	// a languageExchange.
	
	
	@Transactional
	@Test(expected = NullPointerException.class)
	public void testAddDescriptionLanguageExchangeWithDescriptionNull() {
